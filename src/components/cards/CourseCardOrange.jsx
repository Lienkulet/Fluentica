...
const CourseCardOrange = () => (
  <>
    <article className='hidden md:flex flex-row items-end bg-orange1 hover:bg-blue-navy group px-4 md:px-11 pt-5 md:pt-7 pb-0
  md:max-w-195.5 w-full justify-self-center self-center drop-shadow-xl
   rounded-2xl shadow-sm overflow-hidden gap-4 md:gap-4.5 transition-colors duration-400'>
      <div className='relative w-24 h-36 md:w-73.25 md:h-55.75 shrink-0 self-end'>
        <Image src='/assets/courses/corporate.png' alt='Engleză Corporativă' fill
          className='object-contain object-bottom' />
      </div>
      <div className='flex-1 md:max-w-95.25 mb-5 md:mb-7'>
