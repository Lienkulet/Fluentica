...
const TestimonialCard = ({ name, quote }) => {
  ...
  return (
    <article className='bg-white rounded-[20px] px-12.5 pt-8.75 pb-11.75 drop-shadow-sm flex flex-col gap-2.5'>
      <div className='flex items-center justify-between'>
        <div className='flex items-start gap-[11.5px]'>
          ...
          <div className='mr-[15.5px]'>
            ...
            <p className='text-blue-grey text-xs tracking-[3%] leading-normal font-normal mt-1.25 mb-2.75'>Student FLUENTICA</p>
