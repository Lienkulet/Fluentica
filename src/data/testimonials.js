export const testimonials = [
  {
    name: 'Ion Corpocean',
    url: '/assets/testimonials/test1.PNG',
    quote: '„Cea mai mare dificultate pentru mine era să mă exprim. Știam cuvinte și reguli, dar când trebuia să vorbesc mă blocam. La Fluentica am făcut multă practică și am început să vorbesc mai liber și cu mai multă încredere.”',
  },
  {
    name: 'Elena Negarǎ',
  ...
  // {
  //   name: 'Ioana Rusu',
  //   quote: '„Sunt foarte mulțumită de experiența noastră. Copilului meu îi plac mult lecțiile și vine de fiecare dată cu drag. Pentru mine, asta spune totul.”',
  // },
  // {
  //   name: 'Daniela Popa',
  //   quote: '„Copilului meu i-au plăcut foarte mult lecțiile. Explicațiile sunt clare, iar progresul se vede. Sunt foarte bucuroasă că am ales Fluentica.”',
  // },
]